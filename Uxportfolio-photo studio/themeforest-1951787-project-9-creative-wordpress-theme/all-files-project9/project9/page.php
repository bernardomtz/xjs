...
<div class="container" id="single1">
	...
	<div class="row" id="block-single">
		...
		<?php $thumbs = get_post_thumbnail_id(); $images = vt_resize( $thumbs,'' , 640, true ); ?>
		...
		<div class="span8" id="single-content">
			...
			<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
				...
				<iframe src="<?php echo get_post_meta($post->ID, "siiimple_video", $single = true); ?>" width="640" height="300" style="border:0;margin:20px 0px;" id="fit"></iframe>
