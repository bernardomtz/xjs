...
<div class="container" id="single1">
	...
	<div class="single-top-wrap">
		...
		<div class="left-block">
			...
			<?php if ( $cth = get_option('of_cth') ) { ?>
			<h1 class="blog-header"><span><?php echo stripslashes ( $cth ); ?></span></h1>
			<?php } ?>
...
<div class="marketing clients">

			<?php if ( $ctn = get_option('of_ctn') ) { ?> 
			<?php query_posts( 'post_type=logos&posts_per_page=6'. $ctn .'&paged='.$paged); ?>
			<?php } ?>
