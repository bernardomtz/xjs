...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page($themename, $themename .  '&nbsp;Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page','','toplevel_page'); // Default
...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
       <img src="<?php echo get_template_directory_uri(); ?>/admin/images/logo.png" style="padding-top:15px;">
      </div>
