...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			'name' => __('Video'),
			'desc' => __('You can add a video link here.  Be careful to use the correct url for the video.  For YouTube find the embed value code.  For Vimeo, copy and paste the value url.<br/>Example: <span style="font-style:italic;">http://www.youtube.com/v/2Qj8PhxSnhg&hl=en_US&fs=1</span>'),
			'id' => $prefix . 'video',
			'type' => 'text',
			'std' => '',
		),
