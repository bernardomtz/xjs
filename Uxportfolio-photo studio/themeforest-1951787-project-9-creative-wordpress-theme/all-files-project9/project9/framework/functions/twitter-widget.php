...
/* Twitter widget */
/*---------------------------------------------------------------------------------*/
class siiimple_Twitter extends WP_Widget {

   function siiimple_Twitter() {
	   $widget_ops = array('description' => 'Add your Twitter feed to your sidebar with this widget.' );
       parent::WP_Widget(false, __('Project 9 - Twitter Stream'),$widget_ops);      
   }
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <div class="tweet"><ul id="twitter_update_list_<?php echo $unique_id; ?>"><li></li></ul></div>	
        <?php echo siiimple_twitter_script($unique_id,$username,$limit); //Javascript output function ?>	 
...
register_widget('siiimple_Twitter');	
